...
/*
* Permissions
- We create the permissions for the Supabase Kit. These permissions are used to manage the permissions for the roles
...
/*
* Subscription Status
- We create the subscription status for the Supabase Kit. These statuses are used to manage the status of the subscriptions
...
/*
Payment Status
- We create the payment status for the Supabase Kit. These statuses are used to manage the status of the payments
*/
create type public."PaymentStatus" as ENUM('pending', 'succeeded', 'failed');

/*
* Billing Provider
- We create the billing provider for the Supabase Kit. These providers are used to manage the billing provider for the accounts
...
- We create the subscription item type for the Supabase Kit. These types are used to manage the type of the subscription items
...
/*
* Invitation Type
- We create the invitation type for the Supabase Kit. These types are used to manage the type of the invitation
*/
 ...
 * We create the configuration for the Supabase Kit to enable or disable features
 * -------------------------------------------------------
 */
...
comment on table public."Config" is 'Configuration for the Supabase Kit.';
 ...
 * -------------------------------------------------------
 * Section: Accounts
 * We create the schema for the accounts. Accounts are the top level entity in the Supabase Kit. They can be team or personal accounts.
 * -------------------------------------------------------
 */
-- Accounts table
create table if not exists
...
comment on table public."Accounts" is 'Accounts are the top level entity in the Supabase Kit. They can be team or personal accounts.';
