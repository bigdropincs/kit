...
Kit provides a complete authentication system built on Supabase Auth. This guide covers the authentication architecture, implementation details, and how to customize it for your needs.
...
Kit uses multiple Supabase clients optimized for different environments:
...
Kit includes team-based access control:
