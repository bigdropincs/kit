...
Kit is a modern, production-ready starter kit for shipping the same product to web, mobile, browser extension, and desktop - from one TypeScript codebase.

## What is Kit?

Kit is a full-stack TypeScript monorepo that combines the best tools from the modern web ecosystem. Build your product, not your infrastructure.
...
Start with the [installation guide](/docs/overview/installation) to get Kit running locally in minutes.
