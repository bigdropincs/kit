...
How to design tables that fit Kit's architecture. The plumbing - client, config, push workflow - is covered in [Database](/docs/architecture/database); this page is about the schema decisions you'll make for every new feature.
