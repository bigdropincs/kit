      ...
      <div className="mx-auto max-w-lg">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Configure the URL of your Kit application.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-xs">
              The URL of your Kit application. Use http://localhost:3000 for
        ...
        <div className="mt-12 rounded-lg border p-4">
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            The extension popup displays your Kit application in an iframe.
