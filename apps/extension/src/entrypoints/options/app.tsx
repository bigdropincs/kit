  ...
  return (
    <div className="bg-background min-h-screen p-8">
      <div className="mx-auto max-w-lg">
        <div className="mb-8">
          <h1 className="text-2xl font-bold">Kit Extension Settings</h1>
          <p className="text-muted-foreground">Configure the URL of your Kit application.</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground text-xs">
              The URL of your Kit application. Use http://localhost:3000 for local development or
        ...
        <div className="mt-12 rounded-lg border p-4">
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            The extension popup displays your Kit application in an iframe. Make sure your
