...
Kit uses Supabase (PostgreSQL) as the database with Drizzle ORM for type-safe queries. This guide covers the database setup, schema design, and development patterns.
...
Kit includes a comprehensive schema for SaaS applications:
