...
Get Kit up and running on your local machine in just a few minutes. This guide will walk you through setting up the development environment and running your first Kit application.
...
Kit uses pnpm workspaces to manage the monorepo. Install all dependencies:
...
Kit uses Supabase for the database. You have two options:
...
Now that Kit is running locally, you can:
...
Kit comes with several useful scripts:
